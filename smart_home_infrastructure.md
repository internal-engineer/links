...
В данном файле вы найдёте всё, на что я ссылался в видео "[Подготовка сервера умного дома на базе Node-RED, Mosquitto и Zigbee2MQTT](https://youtu.be/IReCHprxwQ8)".  
